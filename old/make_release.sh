...
NODEINST=`which node`
BROWSERIFY=../hybrixd/node_modules/browserify/bin/cmd.js
MINIFY=../hybrixd/node_modules/minifier/index.js
UGLIFY=../hybrixd/node_modules/uglify-es/bin/uglifyjs
CSSMIN=../hybrixd/node_modules/cssmin/bin/cssmin
...
$UGLIFY lib/hybrixdcall.js > $OUTPATH/lib/hybrixdcall.js
