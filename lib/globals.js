// global variables
nodepath = (process.env['CLI4IOC_HOST']?process.env['CLI4IOC_HOST']:'https://wallet.coinstorm.net/api/');

var nbsp = ' ';   // Non-breaking space for correct UI responsiveness (warning: do not edit to normal space)

lang = {
  alertTitle:'Alert',
  alertError:'Error',
  viewLoginBusy:'logging into wallet',
  viewLoginUser:'Account ID',
  viewLoginPass:'Password  ',
  viewLoginEnter:'Please enter your Internet of Coins acount ID and password to log in.',
  viewLoginNeedInfo:'Please specify an account ID, and password of the right length.',
  headerAsset:'Asset',
  headerStarred:'Stars',
  headerBalance:'Balance',
  modalManageAssetsTitle:'Manage assets',
  modalManageAssetsSearchbox:'Search (type and press enter)',
  ...
  buttonManageAssets:'+ Manage assets',
  buttonManageAssetsAdd:'Add +',
  buttonManageAssetsDel:'Remove -',
  buttonCopyClip:'Copy to clipboard',
  buttonSendTx:'Send transaction', buttonOK:'Okay',buttonCancel:'Cancel',buttonClose:'Close',
  buttonSend:'Send', buttonRecv:'Receive', buttonAdv:'>', buttonMax:'Max', buttonStarred: 'Starred',
...
GL = { session:false, sessiondata:null, vars:{}, powqueue:[] };
...
assets['reset']= function () {
  ...
  assets.cntr = {}; // contract addresses of assets
}
...
spinnerStopAll = function(element) {
