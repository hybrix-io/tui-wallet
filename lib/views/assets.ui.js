...
displayAssets = function displayAssets(passdata) {
  ...
  for (var entry in passdata) {
    ...
    var starXPosition = UI.text['AssetsH2'].lpos === undefined ? 18 : UI.text['AssetsH2'].lpos.xi;
    var starStyle = {
    ...
    UI.edit['Starred'+i] = UI.buttonfunc.make(lang.buttonStarred, UI.box, starXPosition + 1, y, '\u2605', 'black', 1, starStyle);
    UI.edit['Starred'+i].on('press', function() {
      ...
      // console.log('foo', UI.edit['Starred'+index])
